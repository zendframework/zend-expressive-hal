...
class HalResponseFactory
{
    ...
    /**
     * @throws InvalidResponseBodyException if the stream factory does not
     *     return a StreamInterface.
     * @throws InvalidResponseBodyException if the stream generated by the
     *     stream factory is not writable.
     */
    public function createStream() : StreamInterface
    {
        $stream = ($this->streamFactory)();
        if (! $body instanceof StreamInterface) {
            throw InvalidResponseBodyException::forIncorrectStreamType();
        }
        if (! $body->isWritable()) {
            throw InvalidResponseBodyException::forNonWritableStream();
        }
        return $stream;
    }
    ...
    private function createResourceElement(DOMDocument $doc, string $name, $data)
    {
        ...
        if (! is_array($data)) {
            throw InvalidResourceValueException::fromValue($data);
        }
